      ...
      module HasQuestionnaire
        ...
        included do
          ...
          def send_confirmation_email
            ...
            Decidim::Surveys::ConfirmationDeliveryJob.perform_now(current_user, @questionnaire, component, user_answers) if component.manifest_name == "surveys" && answers.present?
          end
        end
      end
    end
